...
import {parseCommand, Command} from '../../src/helpers/commands';

const tests:[string, Command][] = [
  ['t @work This is a new task', {command: 't', tag: '@work', text: 'This is a new task' }],
  ['task @longer-task This is another task', {command: 'task', tag: '@longer-task', text: 'This is another task' }],
  ...
  ['e 1 this is a new task description', {command: 'e', id: '1', text: 'this is a new task description' }],
  ['edit 1 a new task description goes here', { command: 'edit', id: '1', text: 'a new task description goes here' }],
  ['mv 2 @new-tag', {command: 'mv', id: '2', tag: '@new-tag' }],
  ['move 3 @uncategorized', {command: 'move', id: '3', tag: '@uncategorized' }],
